                    ...
                    children: [
                        {
                            ...
                            position: "top-5 left-10",
                            description: [
                                "Our Movie Rating App is a fun and interactive way to discover and rate your favorite movies.",
                                "Instead of scrolling through endless lists, you can browse curated collections, read reviews, and share your own ratings.",
                                "Think of it like having a personal movie critic in your pocket—helping you find great films and avoid the duds.",
                                "It’s built with React Native, so it works smoothly on both iOS and Android with a clean, modern design.",
                            ],
                        },
                        // {
...
const ABOUT_LOCATION = {
    ...
    children: [
        ...
        // },
        {
            id: 4,
            name: "about-me.txt",
            icon: "/images/avatar_me_icon.png",
            // icon: "/images/txt.png",
            kind: "file",
            fileType: "txt",
            position: "top-60 left-5",
